...
plt.subplot(3,2,1)  # 3 filas, 2 columnas, el nro del plot a trabajar
plt.plot(t,data)
...
for ptr in range(5,9,2): # ptr va de 5 a 9 de a 2
    s=0
for ptr in caras: # Recorre el contenido de caras
    s=0
