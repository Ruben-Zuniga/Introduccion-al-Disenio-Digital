...
Los scripts \texttt{com\_serie.py} y \texttt{filtro.py} se encuentran en el siguiente link: \url{https://github.com/Ruben-Zuniga/Introduccion-al-Disenio-Digital/tree/main/TP1/scripts}
