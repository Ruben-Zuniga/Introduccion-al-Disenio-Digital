...
Esta nueva implementación se puso a prueba con el VIO, mostrando los resultados en la \autoref{fig:vio_mem}. Al presionar el boton \texttt{probe\_out3}, se habilitó el logueo, donde el led \texttt{probe\_in1[0]} indicó que la memoria se llenó y el led \texttt{probe\_in1[2]} se encendió y apagó para indicar que se había iniciado el proceso.
...
El sistema inicia con el TX y el RX apagados, y se encienden insertando el número 2 y 3 en la consola. En la \autoref{fig:test2_tx} y \ref{fig:test3_rx} se muestra el encendido de estos, con la fase óptima.
...
Para cambiar de fase, debe apagarse el RX y volver a encenderse, como se muestra en la \autoref{fig:test4_ph0}.
...
\begin{figure}[H]
    ...
    \caption{Almacenamiento de los ultimos 8K datos.}
    \label{fig:test8_mem}
\end{figure}
