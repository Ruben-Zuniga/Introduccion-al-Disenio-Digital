...
# set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { o_led_blue[0] }]; #IO_L18N_T2_35 Sch=led0_b
# set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { o_led_green[0] }]; #IO_L19N_T3_VREF_35 Sch=led0_g
##set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { o_led_red[0] }]; #IO_L19P_T3_35 Sch=led0_r
# set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { o_led_blue[1] }]; #IO_L20P_T3_35 Sch=led1_b
# set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { o_led_green[1] }]; #IO_L21P_T3_DQS_35 Sch=led1_g
##set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { o_led_red[1] }]; #IO_L20N_T3_35 Sch=led1_r
